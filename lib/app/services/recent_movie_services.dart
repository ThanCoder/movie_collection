...
class RecentMovieServices {
  static final RecentMovieServices instance = RecentMovieServices._();
  RecentMovieServices._();
  factory RecentMovieServices() => instance;
  ...
  Future<void> add({required String movieId}) async {
    try {
      ...
      //list ရှိနေပြီးတော့ first item က movieId နဲ့တူနေရင် မထည့်ဘူး
      if (list.isNotEmpty && list.first == movieId) {
        return;
      }
  ...
  String getDBPath() {
    return '${PathUtil.instance.getDatabasePath()}/$appRecentDatabaseName';
  }
}
